-- ============================================================================
-- SUPABASE FUNCTIONS BACKUP - SECURITY DEFINER
-- Generated: 2025-01-19
-- Purpose: Complete backup of all SECURITY DEFINER functions for rollback capability
-- Total Functions: 24 SECURITY DEFINER functions found
-- ============================================================================

-- IMPORTANT SECURITY NOTE:
-- All these functions are SECURITY DEFINER which means they run with the privileges of the user who defined them.
-- NONE of these functions currently have "SET search_path" configured, which is a security risk.
-- During RLS implementation, we will add "SET search_path = public, extensions" to all of them.

-- ============================================================================
-- FUNCTION 1: anonymize_contact
-- ============================================================================
...
-- ============================================================================
-- FUNCTION 6: export_dashboard_data
-- ============================================================================
...
-- ============================================================================
-- FUNCTION 7: get_actions_summary
-- ============================================================================
...
-- ============================================================================
-- FUNCTION 8: get_contact_statistics
-- ============================================================================
...
-- ============================================================================
-- FUNCTION 9: get_organization_stats
-- ============================================================================
...
-- ============================================================================
-- FUNCTION 10: get_team_performance_summary
-- ============================================================================
...
-- ============================================================================
-- HELPER FUNCTIONS - CORE SECURITY FUNCTIONS
-- ============================================================================

-- FUNCTION 11: get_user_organization
...
-- FUNCTION 12: get_user_organization_id
...
-- FUNCTION 14: increment_quick_template_usage
...
-- FUNCTION 15: increment_template_usage
...
-- FUNCTION 18: is_user_manager_or_admin
...
-- FUNCTION 19: refresh_all_materialized_views
...
BEGIN
  ...
  -- Refrescar cada vista
  REFRESH MATERIALIZED VIEW CONCURRENTLY mv_team_performance_summary;
  views_refreshed := views_refreshed + 1;
  
  REFRESH MATERIALIZED VIEW CONCURRENTLY mv_contact_insights;
  views_refreshed := views_refreshed + 1;
...
-- FUNCTION 20: schedule_dashboard_refresh
CREATE OR REPLACE FUNCTION public.schedule_dashboard_refresh()
 RETURNS void
 LANGUAGE plpgsql
 SECURITY DEFINER
AS $function$
BEGIN
    ...
    PERFORM refresh_daily_kpi_summary();
    PERFORM refresh_weekly_team_performance();
    
    -- Update team rankings for current date
    PERFORM update_team_rankings(org.id, CURRENT_DATE)
    FROM organizations org;
    
    -- Log the refresh
    INSERT INTO public.system_logs (event, details, created_at)
    VALUES ('dashboard_refresh', 'Materialized views refreshed', now())
...
-- FUNCTION 22: upsert_google_calendar_tokens
...
-- FUNCTION 23: validate_user_session
...
-- ============================================================================
-- ALL 24 functions above are SECURITY DEFINER but NONE have search_path configured!
-- This is a major security vulnerability that needs to be fixed.
--
-- During RLS implementation, each function will be updated to include:
...
-- ============================================================================
-- To rollback any function changes:
-- 1. Copy the original function definition from above
-- 2. Execute it to restore the original version
-- 3. Verify the function works as expected
--
-- To drop a function (BE CAREFUL):
-- DROP FUNCTION IF EXISTS public.function_name(parameters);
--
-- To check if a function is SECURITY DEFINER:
